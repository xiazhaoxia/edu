			...
			<?php if ( buddyboss_is_bp_active() ) { ?>
				...
				<div class="header-account-login">
					...
					<a class="user-link" href="<?php echo bp_core_get_user_domain( get_current_user_id() ); ?>">
						...
						<span>
							<?php  if(!is_weixin()) echo bp_core_fetch_avatar( array( 'item_id' => get_current_user_id(), 'type' => 'full', 'width' => '100', 'height' => '100' ) ); ?>                        </span>
					</a>
					...
					<div class="pop">
						...
						<div id="adminbar-links" class="bp_components">
							<?php if(!is_weixin()) buddyboss_adminbar_myaccount(); ?>
						</div>
