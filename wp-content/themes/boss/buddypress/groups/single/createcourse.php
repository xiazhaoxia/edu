...
if ( $old_post == 'true' ) {
    ...
    if ( 'publish' == $post_status ) {
		...
		$post_status_content = __('In Review','bp-user-blog');
    } else {
        $view_btn_txt = __('Preview','bp-user-blog');
...
//$bp = buddypress();
//$blog_link2 = $bp->members->nav->get_secondary(  array( 'parent_slug' =>__( 'blog', 'bp-user-blog' )));
$blog_link2 = trailingslashit($blog_link . __('pending', 'bp-user-blog'));
	...
	<div class="sap-container<?php echo $container_class; ?>">
		...
		<div class="sap-editor-wrap<?php echo $content_class; ?>">
           ...
           <div class="side-panel">
                    ...
                    <div class="sap-editor-publish-wrapper clearfix">
                        ...
                        <div class="sap-publish-popup">
						   ...
						   ?>
                                        ...
                                        <a class="sap-pending-preview sap-pending-preview-btn button button-secondary sap-disabled" ><?php _e('In Review','bp-user-blog'); ?></a>
							<?php
                                   } 
								   else 
								   { 
							 ?>
                                        ...
                                        <a style="display:none;" class="sap-pending-preview sap-pending-preview-btn button button-secondary sap-disabled" ><?php _e('In Review','bp-user-blog'); ?></a>
							<?php
                                   }
                            }
                            ?>
							...
							{ 
							?>
								<!--a class="sap-story-delete sap-story-delete-btn button button-secondary" href="#">
								<?php //_e('Delete','bp-user-blog'); ?></a-->
						    <?php
							}
							else 
							{ 
						     ?>
								<!--a style="display:none;" class="sap-story-delete sap-story-delete-btn button button-secondary" href="#">
								<?php// _e('Delete','bp-user-blog'); ?>
								</a-->
							<?php
							}
							?>
                ...
                <div class="sap-widget-container">
                    <?php sap_post_category_tags_widget(); ?>
                    <?php //sap_post_featured_img_widget(); ?>
			...
			<div class="sap-editor-area-wrapper tougao-img">
            ...
            <input type="hidden" id="pending-url"         name="pending-url" value="<?php echo $blog_link2; ?>" />
			<input type="hidden" id="classroomid"         name="classroomid" value="<?php echo bp_get_current_group_id(); ?>" />
		</div>
...
<script>
    ...
    jQuery('#sap-cat').val(<?php echo $post_category[0]; ?>);
    jQuery('#sap-cat').change();
    <?php } ?>
