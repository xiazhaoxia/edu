...
if(boss_get_option('boss_cover_profile')) {
    if ( boss_get_option( 'boss_layout_style' ) != 'boxed' && (!bp_is_current_component('events') || bp_is_current_component('events') && 'profile' == bp_current_action() ) ) { // show here for fluid if not Events Manager page or if it is My Profile of Events
            ...
            <div class="table-cell">
                ...
                <div id="item-header-content">
                    <div class="basic">
						...
						<span class="sep"><?php //_e( ', ', 'boss' ); ?></span>
