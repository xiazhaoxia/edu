...
switch ( bp_current_action() ) :
	...
	case 'my-groups' :
		...
		<?php
			function my_groups($filter)
			{
				$userfilter = 'user_id='.bp_displayed_user_id();
				$filter1 =  'type=popular&orderby=total_member_count'.'&'.$userfilter; 
				 
				return $filter1;
			}
			add_filter('bp_ajax_querystring',my_groups);
