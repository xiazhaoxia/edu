...
function groups_screen_group_course() {
	...
	add_action( 'bp_template_content', 'course_template_blog' );
	bp_core_load_template( apply_filters( 'groups_screen_group_course', 'groups/single/plugins' ) );
}
 
function groups_screen_create_course() {
	...
	add_action( 'bp_template_content', 'create_course_template' );
	bp_core_load_template( apply_filters( 'groups_screen_create_course', 'groups/single/plugins' ) );
}

// function groups_screen_hotclassroom() {
	// add_action( 'bp_template_content', 'list_group_template' );
	// bp_core_load_template( apply_filters( 'groups_screen_create_course', 'groups/single/plugins' ) );
// }

// function list_group_template() {
	// bp_get_template_part( 'groups/single/listhotclassrooms');
// }

function create_course_template() {
	//course_load_template( 'sap-post-create' );
	bp_get_template_part( 'groups/single/createcourse');
}

function course_load_template( $template ) {
	$template .= '.php';
...
function course_template_blog() {
	//course_load_template( 'sap-blog-page' );
