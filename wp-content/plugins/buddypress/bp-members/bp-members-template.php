...
function bp_has_members( $args = '' ) {
	...
	if ( bp_is_user_friends() 
	    ...
	    && !bp_is_current_action( 'membersearch' )  
		&& !bp_is_current_action( 'following' )
		&& !bp_is_current_action( 'followers' )) 
	{
	...
	if(bp_is_current_action( 'hottearcher' ))
	{
		$r['type'] = 'popular';
	}
...
function bp_signup_tel_value() {
	echo bp_get_signup_tel_value();
}
	function bp_get_signup_tel_value() {
		$value = '';
		if ( isset( $_POST['signup_tel'] ) )
			$value = $_POST['signup_tel'];
		 ...
		 * @param string $value Email address submitted during signup.
		 */
		return apply_filters( 'bp_get_signup_tel_value', $value );
	}	
/**
