...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    'assets/js/bmt-admin-screen.min.js': [ 'assets/js/bmt-admin-screen.js' ],
                }
            },
        },
        /*
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'bp-member-types', 'buddypress', 'bbpress', 'woothemes-sensei', 'wcvendors-pro', 'woocommerce' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'bp-member-types.pot', // Name of the POT file.
