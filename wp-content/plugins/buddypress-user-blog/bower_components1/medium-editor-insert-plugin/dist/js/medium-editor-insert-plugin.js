...
this["MediumInsert"]["Templates"]["src/js/templates/embeds-wrapper.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"medium-insert-embeds medium-insert-embeds-wpoembeds\" contenteditable=\"false\">\n	<figure>\n		<div class=\"medium-insert-embed\">\n			"
...
this["MediumInsert"]["Templates"]["src/js/templates/images-image.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    return "        <div class=\"medium-insert-images-progress\"></div><i class=\"fa fa-spinner fa-spin\"></i>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
;(function ($, window, document, undefined) {
    ...
    Core.prototype.events = function () {
        ...
        this.$el
            ...
            .on('keyup click focus', $.proxy(this, 'toggleButtons'))
    ...
    Core.prototype.addonAction = function (e) {
        var $a = $(e.target).is('button') ? $(e.target) : $(e.target).closest('a'),
            addon = $a.data('addon'),
...
;(function ($, window, document, undefined) {
    ...
    Embeds.prototype.embed = function (html, url) {
        var $place = this.$el.find('.medium-insert-embeds-active');
        ...
        if (!html) {
            ...
            $place.after("<div class='me_oembed_orig_url' style='display:none' data-url='"+ url +"'></div");
            $place.remove();
