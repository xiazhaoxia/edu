...
if ( !class_exists( 'BuddyBoss_SAP_BP_Component' ) ):
	...
	class BuddyBoss_SAP_BP_Component extends BP_Component {
		...
		public function assets() {
			...
			//wp_enqueue_style( 'jquery-mobile-css', buddyboss_sap()->assets_url . '/css/jquery.mobile-1.4.5.min.css', array(''), '1.0.0', 'all' );
			...
			wp_enqueue_script( 'buddyboss-canvas-to-blob',           buddyboss_sap()->bower_components . '/blueimp-canvas-to-blob/js/canvas-to-blob.js', array(), '1.0.0', true );
			wp_enqueue_script( 'buddyboss-load-image',               buddyboss_sap()->bower_components . '/blueimp-load-image/js/load-image.js', array(), '1.0.0', true );
			wp_enqueue_script( 'buddyboss-load-image-orientation',   buddyboss_sap()->bower_components . '/blueimp-load-image/js/load-image-orientation.js', array(), '1.0.0', true );
			wp_enqueue_script( 'buddyboss-load-image-meta',          buddyboss_sap()->bower_components . '/blueimp-load-image/js/load-image-meta.js', array(), '1.0.0', true );
			wp_enqueue_script( 'buddyboss-load-image-exif',          buddyboss_sap()->bower_components . '/blueimp-load-image/js/load-image-exif.js', array(), '1.0.0', true );
			wp_enqueue_script( 'buddyboss-load-image-exif-map',      buddyboss_sap()->bower_components . '/blueimp-load-image/js/load-image-exif-map.js', array(), '1.0.0', true );
			...
			wp_enqueue_script( 'buddyboss-bower-fileupload-process', buddyboss_sap()->bower_components . '/blueimp-file-upload/js/jquery.fileupload-process.js', array(), '1.0.0', true );			
			wp_enqueue_script( 'buddyboss-bower-load-image',         buddyboss_sap()->bower_components . '/blueimp-file-upload/js/jquery.fileupload-image.js', array(), '1.0.0', true );
			
			//wp_enqueue_script( 'jquery-moible',         buddyboss_sap()->assets_url . '/js/jquery.mobile-1.4.5.min.js', array(), '1.0.0', true );
			//wp_enqueue_script( 'jquery-ui-touch',       buddyboss_sap()->assets_url . '/js/jquery.ui.touch-punch.min.js', array(), '1.0.0', true );
